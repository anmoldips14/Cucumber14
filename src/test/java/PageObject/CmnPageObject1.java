...
public class CmnPageObject1 {
    public static final Logger logger= LogManager.getLogger(CmnPageObject1.class);
    WebDriver driver;
    ...
    public CmnPageObject1(WebDriver driver)
    {
        this.driver=driver;
...
public void validate_Page_Title()
{
    ...
    String expected="Online Shopping site in India: Shop Online for Mobiles, Books ...";
    String actual= driver.getTitle();
    Assert.assertEquals("Title validataion",expected,actual);
